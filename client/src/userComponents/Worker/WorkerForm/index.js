...
import { Button, Grid, TextField, FormHelperText, Stack, InputLabel, OutlinedInput, FormControl, Select, MenuItem, InputAdornment, IconButton } from "@mui/material";
	...
	return (
		<>
			...
			<Grid position="relative" container spacing={2}>
				...
				>
					<WorkerSideBar companyId={params.id} />
				</Grid>
				<Grid item xs>
					<Box
						sx={{
						...
						<Grid sx={{
							...
							<Grid item xs={12}>
								<Box className={styles.rightSideSection}>
									...
									<Box className={styles.workerHeading} component={"h1"}>{t('Add New Worker')}</Box>
															...
															<Grid item xs={12}>
																<Stack spacing={1}>
																	...
																	{downloadStaffPictureURL ? (
																		...
																		<p style={{ color: "red" }}>{t(errors.staffPicture)}</p>
																	)}
																</Stack>
															</Grid>
															<Grid item xs={12}>
